drop table if exists t_shp_drug_stop_sale_notice;

CREATE TABLE `t_shp_drug_stop_sale_notice` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `SHOP_ID` bigint(20) NOT NULL COMMENT '门店 ID',
  `STOP_SALE_NUM` varchar(32) NOT NULL COMMENT '停售 单号',
  `DOC_MAKER_NM` varchar(32) NOT NULL COMMENT '制单人 姓名',
  `APPROVE_MAN_ID` bigint(20) NOT NULL COMMENT '复核人 ID',
  `MAKE_TIME` datetime NOT NULL COMMENT '制单 时间',
  `STOP_SALE_DATE` date NOT NULL COMMENT '停售 日期',
  `QUALITY_STATE` varchar(64) DEFAULT NULL COMMENT '质量 状况',
  `STOP_SALE_SUGGEST` varchar(64) DEFAULT NULL COMMENT '停售 意见',
...
drop table if exists t_shp_stop_sale_goods_inf;

CREATE TABLE `t_shp_stop_sale_goods_inf` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `DRUG_STOP_SALE_NOTICE_ID` bigint(20) NOT NULL COMMENT '药品 停售 通知单 ID',
