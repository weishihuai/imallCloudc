create table T_SHP_DRUG_CHECK_RECORD
(
   ID                   bigint not null auto_increment comment '主键',
   SHOP_ID              bigint not null comment '门店 ID',
   CHECK_NUM            varchar(32) not null comment '检查 单码',
   CHECK_TIME           date not null comment '检查 时间',
   APPROVE_MAN_ID       bigint not null comment '审核人 ID',
   ...
   CHECK_QUANTITY       bigint not null comment '检查 数量',
   CHECK_PRJ            varchar(32) comment '检查 项目',
