 ...
 */
@Entity
@Table(name = "t_shp_goods_chinese_medicine_pieces" )
public class GoodsChineseMedicinePieces extends BaseEntity<Long>{
	...
	public boolean equals(Object obj) {
		...
		if(!(obj instanceof GoodsChineseMedicinePieces)){
			return false;
		}
		if(this == obj) {
			return true;
		}
		GoodsChineseMedicinePieces other = (GoodsChineseMedicinePieces)obj;
