 ...
 * 不良反应报告 更新 VO对象
 */
public class BadReactionRepUpdateVo {
    /**
     * 不良反应报告 主键ID
     */
    private Long id;
     ...
     * 不良反应报告中的药品信息 (怀疑药品集合)
     */
    private List<SuspectDrugUpdateVo> suspectDrugList;

    /**
     * 不良反应报告中的药品信息 (并用药品集合)
     */
    private List<BlendDrugUpdateVo> blendDrugList;
    ...
    public List<SuspectDrugUpdateVo> getSuspectDrugList() {
        return suspectDrugList;
    }

    public void setSuspectDrugList(List<SuspectDrugUpdateVo> suspectDrugList) {
        this.suspectDrugList = suspectDrugList;
    }

    public List<BlendDrugUpdateVo> getBlendDrugList() {
        return blendDrugList;
    }

    public void setBlendDrugList(List<BlendDrugUpdateVo> blendDrugList) {
        this.blendDrugList = blendDrugList;
    }
}
