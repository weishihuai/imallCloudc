 ...
 */
@Entity
@Table(name = "t_ptfm_goods_doc_daily_necessities" )
public class GoodsDocDailyNecessities extends BaseEntity<Long>{
	...
	public boolean equals(Object obj) {
		...
		if(!(obj instanceof GoodsDocDailyNecessities)){
			return false;
		}
		if(this == obj) {
			return true;
		}
		GoodsDocDailyNecessities other = (GoodsDocDailyNecessities)obj;
