 ...
 * 不良反应报告 保存 VO对象
 */
public class BadReactionRepSaveVo {
    /**
     * SHOP_ID - 门店 ID
     */
    @NotNull
     ...
     * 不良反应报告中的药品信息 (怀疑药品集合)
     */
    private List<SuspectDrugSaveVo> suspectDrugList;

    /**
     * 不良反应报告中的药品信息 (并用药品集合)
     */
    private List<BlendDrugSaveVo> blendDrugList;
    ...
    public List<SuspectDrugSaveVo> getSuspectDrugList() {
        return suspectDrugList;
    }

    public void setSuspectDrugList(List<SuspectDrugSaveVo> suspectDrugList) {
        this.suspectDrugList = suspectDrugList;
    }

    public List<BlendDrugSaveVo> getBlendDrugList() {
        return blendDrugList;
    }

    public void setBlendDrugList(List<BlendDrugSaveVo> blendDrugList) {
