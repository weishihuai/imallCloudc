...
public class SupplierUpdateVo {
     ...
     */
    @NotEmpty
    private List<SupplierCertificatesFileUpdateVo> supplierCertificatesFileList;
    /**
     * 申请 人
     */
    @Length(max = 32)
    ...
    public List<SupplierCertificatesFileUpdateVo> getSupplierCertificatesFileList() {
        return supplierCertificatesFileList;
    }

    public void setSupplierCertificatesFileList(List<SupplierCertificatesFileUpdateVo> supplierCertificatesFileList) {
