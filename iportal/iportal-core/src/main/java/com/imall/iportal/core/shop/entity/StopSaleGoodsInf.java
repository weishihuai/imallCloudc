 ...
 */
@Entity
@Table(name = "t_shp_stop_sale_goods_inf")
public class StopSaleGoodsInf extends BaseEntity<Long> {

    public static final String DRUG_STOP_SALE_NOTICE_ID = "drugStopSaleNoticeId";
    ...
    /**
     * DRUG_STOP_SALE_NOTICE_ID - 药品 停售 通知单 ID
     */
    @Column(name = "DRUG_STOP_SALE_NOTICE_ID", unique = false, nullable = false, insertable = true, updatable = true, length = 19)
    ...
    public void setDrugStopSaleNoticeId(Long value) {
        this.drugStopSaleNoticeId = value;
    }

    public Long getDrugStopSaleNoticeId() {
        return this.drugStopSaleNoticeId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                .append("ID", getId())
                .append("DRUG_STOP_SALE_NOTICE_ID", getDrugStopSaleNoticeId())
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof StopSaleGoodsInf)) {
            return false;
        }
        if (this == obj) {
            return true;
        }
        StopSaleGoodsInf other = (StopSaleGoodsInf) obj;
