 ...
 */
@Entity
@Table(name = "t_shp_goods_daily_necessities" )
public class GoodsDailyNecessities extends BaseEntity<Long>{
	...
	public boolean equals(Object obj) {
		...
		if(!(obj instanceof GoodsDailyNecessities)){
			return false;
		}
		if(this == obj) {
			return true;
		}
		GoodsDailyNecessities other = (GoodsDailyNecessities)obj;
