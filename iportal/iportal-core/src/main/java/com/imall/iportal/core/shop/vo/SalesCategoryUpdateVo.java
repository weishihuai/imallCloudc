 ...
 */
public class SalesCategoryUpdateVo {
    /**
     * 销售分类ID
     */
    @NotNull
    ...
    public Long getNewSysFileLibId() {
        return newSysFileLibId;
    }

    public void setNewSysFileLibId(Long newSysFileLibId) {
        this.newSysFileLibId = newSysFileLibId;
    }

    public String getNewPictFileId() {
        return newPictFileId;
    }

    public void setNewPictFileId(String newPictFileId) {
        this.newPictFileId = newPictFileId;
    }
}
