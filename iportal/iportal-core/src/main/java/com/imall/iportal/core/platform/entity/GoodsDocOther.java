 ...
 */
@Entity
@Table(name = "t_ptfm_goods_doc_other" )
public class GoodsDocOther extends BaseEntity<Long>{
	...
	public boolean equals(Object obj) {
		...
		if(!(obj instanceof GoodsDocOther)){
			return false;
		}
		if(this == obj) {
			return true;
		}
		GoodsDocOther other = (GoodsDocOther)obj;
