...
public class MySessionValidationScheduler implements SessionValidationScheduler, Runnable {
    ...
    @Autowired
    private MCSessionDAO mcSessionDAO;
    ...
    public void enableSessionValidation() {
        if (this.sessionValidationInterval > 0l) {
            ...
            this.service.scheduleAtFixedRate(this, sessionValidationInterval, sessionValidationInterval, TimeUnit.MILLISECONDS);
            this.enabled = true;
        }
    }
    ...
    public void run() {
        ...
        Collection<Session> sessionList = mcSessionDAO.getActiveSessions();
