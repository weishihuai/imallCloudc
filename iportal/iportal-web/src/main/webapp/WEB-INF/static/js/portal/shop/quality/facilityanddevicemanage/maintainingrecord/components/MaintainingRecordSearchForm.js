...
class MaintainingRecordSearchForm extends Component{
    constructor(props) {
        super(props);
    }
    ...
    search() {
        ...
        let maintainResponseMan = $("#sMaintainResponseMan").val().trim();
        params = Object.assign(params, {
            deviceTypeCode: deviceTypeCode,             //设备类型代码
            deviceNum: deviceNum,                       //设备编号
            deviceNm: deviceNm,                         //设备名称
            maintainResponseMan: maintainResponseMan    //操作人
        });
        actions.maintainingRecordSearch(params);
    }
    ...
    render() {
        ...
        return (
            <div className="lt-cont">
                ...
                <div className="search">
                    <input placeholder="检修负责人" type="text" id="sMaintainResponseMan"/>
                </div>
...
MaintainingRecordSearchForm.prpoTypes = {
    actions: PropTypes.object.isRequired
};

MaintainingRecordSearchForm.contextTypes = {
    store: React.PropTypes.object
};

export default MaintainingRecordSearchForm;