...
class FacilityAndDeviceAccountsAddForm extends Component{
    constructor(props) {
        super(props);
    }
                        ...
                        <div className="layer-body">
                            <div className="md-box">
                                <div className="box-mc clearfix">
                                    ...
                                    <Field name="responseMan"  type="text" component={inputField} label="负责人" maxLength="32" required="required" />
...
FacilityAndDeviceAccountsAddForm.propTypes = {
...
FacilityAndDeviceAccountsAddForm.contextTypes = {
...
FacilityAndDeviceAccountsAddForm = reduxForm({
    form: 'facilityAndDeviceAccountsAddForm',
    enableReinitialize: true
})(FacilityAndDeviceAccountsAddForm);

FacilityAndDeviceAccountsAddForm = connect(
    mapStateToProps,
    mapDispatchToProps
)(FacilityAndDeviceAccountsAddForm);

export default FacilityAndDeviceAccountsAddForm;