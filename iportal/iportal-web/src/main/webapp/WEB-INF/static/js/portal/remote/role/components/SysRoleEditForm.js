...
class SysRoleEditForm extends React.Component {
                ...
                <div className="layer" >
                    <div className="layer-box layer-start layer-post-add w430">
                        ...
                        <div className="layer-footer">
                            <button type="submit" style={{border: "none"}} className="confirm" onClick={() => {this.props.checkValidForm(true)}} disabled={submitting}>{submitting ? <i/> : <i/>} 保存</button>
...
SysRoleEditForm.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};
SysRoleEditForm.contextTypes = {
...
SysRoleEditForm = reduxForm({
    form: "sysRoleEditForm",
    enableReinitialize: true,
    asyncBlurFields: ['roleCode'],
    asyncValidate: asyncValidateForSaveOrUpdate
})(SysRoleEditForm);

SysRoleEditForm = connect(
    mapStateToProps,
    mapDispatchToProps
)(SysRoleEditForm);

export default SysRoleEditForm