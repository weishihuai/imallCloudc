...
export const goodsNameInput = ({ input, type,className,maxLength, id,required, meta: { touched, error } }) => (
...
export const dateField = ({ input, change,type,className,placeholder, id,required, meta: { touched, error } }) => (
    <TimeSelect type={type} id={id} change={change} className={className} placeholder={placeholder} name={input.name} readOnly="readOnly" required={required}/>
);
                ...
                <div className="layer">
                    ...
                    <div className="layer-box layer-info w960">
                        <div className="layer-header">
                            <span>添加商品</span>
                            <a href="javascript:void(0);" className="close" onClick={()=>actions.changeAddGoodFormState(false)}/>
                        </div>
                        <div className="layer-body">
                            <div className="md-box">
                                ...
                                <div className="box-mc clearfix">
                                    ...
                                    <div className="item" style={{position:"relative"}}>
                                        <p><i>*</i>商品名称<a className="item-input-a" onClick={()=>actions.changeGoodsDocSelectListState(true)}/></p>
                                        <Field id="goodsNm" name="goodsNm" type="text" className=""  component={goodsNameInput} required="required"/>
                                    </div>
                                    <div className="item">
                                        <p><i>*</i>商品类型</p>
                                    ...
                                    <div className="item">
                                        <p>{IS_DRUG&&<i>*</i>}批准文号期限</p>
                                                <Field id="approvalNumberTermString" name="approvalNumberTermString" type="text"  component={dateField} change={change} className="form-control datepicker" />
                                    </div>}
                                    ...
                                    <div className="item">
                                        <p>批准日期</p>
                                        <Field id="approveDateString" name="approveDateString" type="text"  component={dateField} change={change} className="form-control datepicker" />
                                    </div>}
                                    ...
                                    <div className="item">
                                        <p><i>*</i>生产日期</p>
                                        <Field id="productionDateString" name="productionDateString" type="text"   className="form-control datepicker" component={dateField} change={change} required="require"  />
                                    </div>}

                                    {IS_FOOD_HEALTH &&
                                    <div className="item">
                                        <p><i>*</i>保质期</p>
                                        <Field id="expirationDateString" name="expirationDateString" type="text"   className="form-control datepicker" component={dateField} change={change}  required="require"  />
                                    </div>}
                            ...
                            <div className="md-box">
                                ...
                                <div className="box-mc clearfix">
                                    ...
                                    <div className="item splitZeroState" style={{display:"none"}}>
                                        <p><i>*</i>拆零单位</p>
                                    ...
                                    <div className="item splitZeroState" style={{display:"none"}}>
                                        <p><i>*</i>拆零数量</p>
                                        <Field id="splitZeroQuantity" maxlength="7" name="splitZeroQuantity" type="text" className="" component={simpleInput} required="required"/>
                                    </div>
                            ...
                            <div className="md-box">
                                ...
                                <div className="box-mc clearfix">
                                    ...
                                    <Field id="isFirstSell" name="isFirstSell" type="text" component={simpleRadioField} label="首营" required="required"/>
                                    <div className="item"></div>
                                    <div className="item"></div>
                                    <div className="item w450">
                                        <p>提交意见</p>
                        ...
                        <div className="layer-footer">
                            ...
                            <a href="javascript:void(0);" className="cancel" onClick={()=>actions.changeAddGoodFormState(false)}>取消</a>
                        </div>
                    </div>
                    {store.getState().todos.goodsDocSelectListState&&<GoodsDocSelectList store={store} actions={actions} isAdd={true}/>}
                </div>
            </form>
        )
    }
...
GoodsAddForm.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};
GoodsAddForm.contextTypes = {
