...
import {portalAppAddModal} from '../actions';
import {validate} from '../../../../common/common-validate';

export const fields = [ 'appName', 'appCname', 'appKey' ,'appSecret','hostname','webContext','orderby','isAvailable']

class AppAddForm extends Component {
    render() {
        const { portalAppAddModal,fields: { appName, appCname, appKey ,appSecret,hostname,webContext,orderby,isAvailable}, resetForm, handleSubmit, submitting } = this.props
        return (
            <form className="form-horizontal" onSubmit={handleSubmit}>
                <div className="form-group">
                    <label className="control-label col-md-3">应用名称：</label>
                    <div className="col-md-6">
                        <input id="appName" className="form-control required" data-max-length="100" type="text" placeholder="应用名称"  {...appName}/>
                    </div>
                ...
                <div className="form-group">
                    ...
                    <div className="col-md-6">
                        <input id="appCname" className="form-control required" data-max-length="100" type="text" placeholder="应用中文名称"  {...appCname}/>
                    </div>
                ...
                <div className="form-group">
                    ...
                    <div className="col-md-6">
                        <input id="appKey" className="form-control required"  data-max-length="100" type="text" placeholder="应用KEY"  {...appKey}/>
                    </div>
                ...
                <div className="form-group">
                    ...
                    <div className="col-md-6">
                        <input id="appSecret" className="form-control required"  data-max-length="100" type="text" placeholder="APP_SECRET" {...appSecret}/>
                    </div>
                ...
                <div className="form-group">
                    ...
                    <div className="col-md-6">
                        <input id="hostname" className="form-control required" data-max-length="100" type="text" placeholder="hostname" {...hostname}/>
                    </div>
                ...
                <div className="form-group">
                    ...
                    <div className="col-md-6">
                        <input id="webContext" className="form-control required" data-max-length="100" type="text" placeholder="应用上下文"  {...webContext}/>
                    </div>
                ...
                <div className="modal-footer" style={{"background":"none"}}>
                    ...
                    <button className="btn btn-default ngdialog-custom-close" type="button" disabled={submitting} onClick={portalAppAddModal}>
                        关闭
                    </button>
                </div>
            </form>
