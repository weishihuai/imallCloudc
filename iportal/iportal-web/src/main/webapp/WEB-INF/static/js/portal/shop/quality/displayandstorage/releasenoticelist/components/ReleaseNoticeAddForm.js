...
class ReleaseNoticeAddForm extends Component{
    constructor(props) {
        super(props);
    }
    ...
    submit(data){
        ...
        selectedPage.content.map((content,index)=>{
            ...
            releaseGoodsInfSaveVos.push(obj);
        });

        this.props.actions.saveStopSalseNotice(Object.assign({},data,{
            releaseGoodsInfSaveVos:releaseGoodsInfSaveVos
        }),params,page);
    }
    ...
    componentDidMount() {
        ...
        $("#releaseDateStr").on("click", function (e) {
            e.stopPropagation();
            $(this).lqdatetimepicker({
                css: 'datetime-day',
                dateType: 'D',
                selectback: function () {
                    change("releaseDateStr",$("#releaseDateStr").val());
                }
            });
        });
    }
    ...
    openCommonGoodsBatchSelectWin() {
        this.props.changeCommonGoodsBatchListState({isSingle:false,batchState:"STOP_SALE"}, (selectedGoodsList)=>{
            ...
            store.dispatch({
                type:types.RELEASE_NOTICE_ADD_GOODS_BATCH_PAGE,
                data:page,
    ...
    onRowSelect(store,content){
        ...
        store.dispatch({
            type:types.RELEASE_NOTICE_ADD_CHANGE_SELECTED_PAGE,
    ...
    deleteContents(){
        ...
        store.dispatch({
            type:types.RELEASE_NOTICE_DELETE_GOODS_BATCH_CONTENTS,
            data:page
        })
    }
                        ...
                        <div className="layer-body">
                            <div className="md-box">
                                ...
                                <div className="box-mc clearfix">
                                    ...
                                    <Field id="releaseDateStr" name="releaseDateStr" required="required" inputClassName="form-control datepicker" type="text" component={inputField} label="解停日期" readOnly/>
                                    <Field name="qualityState" id="qualityState" type="text" label="质量状况" component={inputField} />
                                    <Field name="releaseSuggest" id="releaseSuggest" type="text" label="解停意见" component={inputField} />
                                    <div className="item">
                                        <p><i>*</i>审核人</p>
...
ReleaseNoticeAddForm.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};

ReleaseNoticeAddForm.contextTypes = {
...
ReleaseNoticeAddForm = reduxForm({
    form: 'releaseNoticeAddForm',
    validate:validate
})(ReleaseNoticeAddForm);

ReleaseNoticeAddForm = connect(
    mapStateToProps,
    mapDispatchToProps
)(ReleaseNoticeAddForm);

export default ReleaseNoticeAddForm;
