...
class SysUserPassWordUpdateForm extends React.Component {
...
SysUserPassWordUpdateForm.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};
SysUserPassWordUpdateForm.contextTypes = {
...
SysUserPassWordUpdateForm = reduxForm({
    form: 'sysUserPassWordUpdateForm',
})(SysUserPassWordUpdateForm);

SysUserPassWordUpdateForm = connect(
    mapStateToProps,
    mapDispatchToProps
)(SysUserPassWordUpdateForm);

export default SysUserPassWordUpdateForm
