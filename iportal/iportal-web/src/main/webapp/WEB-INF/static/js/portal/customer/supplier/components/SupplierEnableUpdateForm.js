...
class SupplierEnableUpdateForm extends React.Component {
...
SupplierEnableUpdateForm.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};
SupplierEnableUpdateForm.contextTypes = {
...
SupplierEnableUpdateForm = reduxForm({
    form: 'supplierEnableUpdateForm',
})(SupplierEnableUpdateForm);

SupplierEnableUpdateForm = connect(
    mapStateToProps,
    mapDispatchToProps
)(SupplierEnableUpdateForm);

export default SupplierEnableUpdateForm
