...
/*近效期催销 搜索表单*/
class ExpiryWarningSearchForm extends Component {
    ...
    handleSearch() {
        ...
        this.props.actions.expiryWarningList(newParam, 0, 10);
    };
    ...
    onResetSearchParam() {
        ...
        this.props.actions.expiryWarningList({}, 0, 10)
    }
...
ExpiryWarningSearchForm.contextTypes = {
    store: React.PropTypes.object
};

export default ExpiryWarningSearchForm;