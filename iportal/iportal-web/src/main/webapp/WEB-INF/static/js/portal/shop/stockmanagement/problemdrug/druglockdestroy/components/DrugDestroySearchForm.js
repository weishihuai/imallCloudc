...
class DrugDestroySearchForm extends Component {
    ...
    handleSearch() {
        ...
        this.props.actions.drugDestroyList(newParam, 0, 10);
    };
    ...
    onResetSearchParam() {
        ...
        this.props.actions.drugDestroyList({}, 0, 10);
    }
...
DrugDestroySearchForm.contextTypes = {
    store: React.PropTypes.object
};

export default DrugDestroySearchForm;