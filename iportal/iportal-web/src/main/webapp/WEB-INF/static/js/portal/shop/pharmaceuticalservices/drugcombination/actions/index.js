...
export function showEditForm(isShowEdit, id={}) {
    return function(dispatch){
        if(isShowEdit) {
            let url = iportal + "/drugCombination/findById.json?id="+id;
            return fetch(url, {
                mode: 'cors',
                credentials: 'include',
                method: 'GET',
...
export function saveOrUpdate(data, actions, params){
    ...
    let isAdd = false;
    if(data.id){
        url = iportal + "/drugCombination/update.json";
    }else{
        isAdd = true;
        url = iportal + "/drugCombination/save.json";
    }
...
export function drugCombinationList(params, page, size) {
    return function (dispatch) {
        return fetch(iportal + '/drugCombination/query.json?drugCombinationCategoryId='
...
export function del(id, params){
    return function (dispatch) {
        ...
        return fetch(iportal + '/drugCombination/delete.json', {
            mode: 'cors',
            credentials: 'include',
            method: 'POST',
            redirect: 'follow',
...
export function initCategories(callbackFun = ()=>{}){
    return function (dispatch) {
        return fetch(iportal + '/drugCombination/listAllCategory.json', {
            mode: 'cors',
            credentials: 'include',
            method: 'GET',
            redirect: 'follow',
