...
class AcceptanceRecordList extends Component {
                        ...
                        <div className="main">
                            <div className="mt">
                                <div className="mt-lt">
                                    ...
                                    <span>></span>
                                    <a href="javascript:;">采购与验收</a>
                                    <span>></span>
                                    <a href="javascript:;">验收记录</a>
...
AcceptanceRecordList.propTypes = {
    actions: PropTypes.object.isRequired
}

AcceptanceRecordList.contextTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(AcceptanceRecordList);