                             ...
                             content.map((ct, i)=> {
                                 return (
                                     <tr key={i}>
                                         ...
                                         <td>
                                             <div className="td-cont" title={ct.purchaseUnitPrice}>{ct.purchaseUnitPrice}</div>
                                         </td>
                                         <td>
                                             <div className="td-cont" title={ct.purchaseUnitPrice*ct.purchaseQuantity}>{ct.purchaseUnitPrice*ct.purchaseQuantity}</div>
                                         </td>
                                         <td>
