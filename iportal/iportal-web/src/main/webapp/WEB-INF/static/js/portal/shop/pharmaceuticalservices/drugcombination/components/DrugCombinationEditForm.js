...
class DrugCombinationEditForm extends Component{
    constructor(props) {
        super(props);
    }
    ...
    render() {
        ...
        return(
            <form className="form-horizontal" onSubmit={handleSubmit} id="editForm">
...
DrugCombinationEditForm.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};

DrugCombinationEditForm.contextTypes = {
...
DrugCombinationEditForm = reduxForm({
    form: 'drugCombinationEditForm',
    enableReinitialize: true
})(DrugCombinationEditForm);

DrugCombinationEditForm = connect(
    mapStateToProps,
    mapDispatchToProps
)(DrugCombinationEditForm);

export default DrugCombinationEditForm;
