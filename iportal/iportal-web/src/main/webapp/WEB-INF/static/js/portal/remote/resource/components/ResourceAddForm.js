...
import {portalResourceAddModal} from "../actions";
import {validate} from "../../../../common/common-validate";

export const fields = [ 'parentId','resourceName', 'permissionCode', 'resourceType' ,'routerKey','routerTemplateJs','orderby','isAvailable','appId'];
...
class ResourceAddForm extends Component {
    render() {
        const { portalResourceAddModal, handleSubmit, submitting } = this.props;
        ...
        return (
            <form className="form-horizontal" onSubmit={handleSubmit}>
                ...
                <div className="modal-footer" style={{"background":"none"}}>
                    ...
                    <button className="btn btn-default ngdialog-custom-close" type="button" disabled={submitting} onClick={portalResourceAddModal}>
                        关闭
                    </button>
                </div>
            </form>
...
ResourceAddForm.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};

ResourceAddForm.contextTypes = {
...
ResourceAddForm = reduxForm({
    form: 'resourceAddForm',
    enableReinitialize: true,
    validate
})(ResourceAddForm);

ResourceAddForm = connect(
    mapStateToProps,
    mapDispatchToProps
)(ResourceAddForm);
