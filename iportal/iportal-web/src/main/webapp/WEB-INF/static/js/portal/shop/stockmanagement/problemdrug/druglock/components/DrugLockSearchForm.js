...
class DrugLockSearchForm extends Component {
    ...
    handleSearch() {
        ...
        this.props.actions.drugLockList(newParam, 0, 10);
    };
    ...
    onResetSearchParam() {
        ...
        this.props.actions.drugLockList({}, 0, 10);
    }
...
DrugLockSearchForm.contextTypes = {
    store: React.PropTypes.object
};

export default DrugLockSearchForm;