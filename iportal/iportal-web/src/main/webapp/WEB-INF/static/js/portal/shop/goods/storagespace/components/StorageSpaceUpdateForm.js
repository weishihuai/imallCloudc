...
class StorageSpaceUpdateForm extends Component {
    ...
    submit(data){
        ...
        return this.props.actions.storageSpaceUpdateData(data,params);
    }
                ...
                <div className="layer" >
                    <div className="layer-box layer-verify w430">
                        <div className="layer-header">
                            <span>修改货位信息</span>
                            <a href="javascript:void(0);" className="close" onClick={(e) => actions.storageSpaceEditModel(false)}/>
                        </div>
                        <div className="layer-body">
                            <Field id="storageSpaceNm" name="storageSpaceNm" type="text" component={inputField} label="货位名称" required="required"  maxLength="32"/>
                            <Field id="storageSpaceTypeUpdate" name="storageSpaceType" type="text" component={storageSpaceTypeField} label="货位类型" required="required" />
                            <div className="item">
                        ...
                        <div className="layer-footer">
                            ...
                            <a href="javascript:void(0);" className="cancel" onClick={(e) => actions.storageSpaceEditModel(false)}>取消</a>
                        </div>
                    </div>
                </div>
            </form>
...
StorageSpaceUpdateForm.contextTypes = {
    store: React.PropTypes.object
};

StorageSpaceUpdateForm.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};

StorageSpaceUpdateForm = reduxForm({
    form: "storageSpaceUpdateForm",
...
export default connect(mapStateToProps, mapDispatchToProps)(StorageSpaceUpdateForm);