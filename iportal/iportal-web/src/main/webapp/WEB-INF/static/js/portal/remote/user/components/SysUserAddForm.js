...
export const fields = [
    ...
    validate: {
        fieldNm: "用户名",
        required: true,
        regx:validMessage.REGEXP_INT_AND_LETTER,
        maxlength: 16,
...
// 岗位
export const businessCategoryRadioField = ({  input, allItems, changeEven = () => {} }) => {
...
class SysUserAddForm extends React.Component {
    ...
    businessCategoryChangeEven(e){
        ...
        var jobSelectList = form.sysUserAddForm.values.jobSelectList||[];
                ...
                <div className="layer" >
                    <div className="layer-box layer-info layer-order layer-staff-management w960">
                        ...
                        <div className="layer-body">
                            ...
                            <div className="md-box">
                                <div className="box-mt"><p><i style={{color:"#EE0000"}}>*</i>岗位</p></div>
                                <div className="box-mc clearfix">
                                    <Field label="岗位" name="jobSelectList" required="required" component={businessCategoryRadioField} changeEven={(e) => {this.businessCategoryChangeEven(e)}}  allItems={allJobs}/>
                                </div>
                            </div>
                            <div className="md-box">
...
SysUserAddForm.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};
SysUserAddForm.contextTypes =  {
...
function mapStateToProps(state) {
    return {
        fields: fields,
        initialValues:{isPostsTrain:"Y"},
        enableReinitialize:true,
        validate: validate,
        state
    };
}
SysUserAddForm = reduxForm({
    form: "sysUserAddForm",
    enableReinitialize: true,
...
SysUserAddForm = connect(
    mapStateToProps,
    mapDispatchToProps
)(SysUserAddForm);

export default SysUserAddForm