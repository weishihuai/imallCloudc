...
class DrugCombinationCategoryList extends Component{
    ...
    componentWillMount() {
        ...
        this.props.portalOperationalAuth(["pharmaceuticalCare:combination:portalCombinationCategory:add", "pharmaceuticalCare:combination:portalCombinationCategory:delete", "pharmaceuticalCare:combination:portalCombinationCategory:update"]);
            ...
            <div className="main-box">
                ...
                <div className="main">
                    <div className="mt">
                        ...
                        <div className="mt-rt">
                            <Imalla href="javascript:void(0);" permissionCode="pharmaceuticalCare:combination:portalCombinationCategory:add" className="added" onClick={this.showAddForm.bind(this)} text="添加" />
                        </div>
                    </div>
                    <div className="mc">
                                                ...
                                                <td>
                                                    {
                                                        ...
                                                        <div className="td-cont" style={{"paddingLeft" : 0, "paddingRight" : 25 + "px", "textAlign" : "right"}}>
                                                            <Imalla href="javascript:void(0);" permissionCode="pharmaceuticalCare:combination:portalCombinationCategory:delete" className="gray-btn" text="删除" onClick={()=>this.props.actions.showDelConfirm(true, record.id)}  />
                                                            <Imalla href="javascript:void(0);" permissionCode="pharmaceuticalCare:combination:portalCombinationCategory:update" className="gray-btn" text="修改" onClick={()=>this.props.actions.showEditForm(true, record)} />
                                                        </div>
                                                    }
                                                </td>
                                            </tr>
