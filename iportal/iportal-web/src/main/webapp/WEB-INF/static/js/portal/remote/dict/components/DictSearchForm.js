...
class DictSearchForm extends Component {
    constructor(props) {
        super(props);
    };
                        ...
                        <div className="input-group">
                            <div className="input-group-btn" id="searchTypeMenu">
                                <button type="button" className="btn btn-default dropdown-toggle"
                                    ...
                                    <span className="icon-share">名称</span>
                                    <span className="caret"></span>
                                </button>
                                <ul className="dropdown-menu">
                                    <li data-type="dictNm"><a href="javascript:void(0)">名称</a></li>
                                    <li data-type="dictType"><a href="javascript:void(0)">类型</a></li>
                                </ul>
                            </div>
                            <input name="dictNm" type="text" className="form-control"/>
