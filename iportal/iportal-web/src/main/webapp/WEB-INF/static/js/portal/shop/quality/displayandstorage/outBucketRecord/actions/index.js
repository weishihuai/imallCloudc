...
export function queryList(params, page, size) {
    return function (dispatch) {
        ...
        var paramUrl = $.query
            ...
            .set('cleaningBucketManNm', params.cleaningBucketManNm || "")
        ...
        return fetch(iportal + '/chineseMedicinePiecesCleaningBucketRecord/queryChineseMedicinePiecesCleaningBucketRecord.json' + paramUrl, {
            mode: 'cors',
            credentials: 'include',
            method: 'get'
        })
