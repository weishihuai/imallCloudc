...
class ReceiveAddrAdd extends Component{
    ...
    render(){
        ...
        const {store} = this.context;
        const {showSelectZone} = store.getState().receiveAddrTodos;
                ...
                <div className="main-index add-address">
                    <form onSubmit={handleSubmit(data => saveReceiveAddr(data))}>
                        ...
                        <div className="submit">
                            <label><input onClick={() => this.showErrorMessage()} disabled={submitting} type="submit" value="确定"/></label></div>
                    </form>
                </div>
                }
            </div>
...
ReceiveAddrAdd.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};

ReceiveAddrAdd.contextTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ReceiveAddrAdd);