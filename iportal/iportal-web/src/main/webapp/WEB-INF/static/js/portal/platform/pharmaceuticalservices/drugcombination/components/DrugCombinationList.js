...
class DrugCombinationList extends Component{
    ...
    componentWillMount() {
        ...
        this.props.portalOperationalAuth([
            "pharmaceuticalCare:combination:portalCombination:add",
            "pharmaceuticalCare:combination:portalCombination:delete",
            "pharmaceuticalCare:combination:portalCombination:update",
            "pharmaceuticalCare:combination:portalCombination:detail"
        ]);
            ...
            <div className="main-box">
                ...
                <div className="main">
                    <div className="mt">
                        ...
                        <div className="mt-rt">
                            <Imalla href="javascript:void(0);" permissionCode="pharmaceuticalCare:combination:portalCombination:add" className="added" onClick={this.showAddForm.bind(this)} text="添加" />
                        </div>
                    </div>
                    <div className="mc">
                                                ...
                                                <td>
                                                    {
                                                        <div className="td-cont" style={{paddingLeft : 0, paddingRight : 25 + 'px', textAlign : 'right'}} >
                                                            <Imalla href="javascript:void(0);" permissionCode="pharmaceuticalCare:combination:portalCombination:detail" className="gray-btn" text="查看" onClick={() => this.props.actions.showDetail(true, record.id)}  />
                                                            {
                                                                record.orgId===record.currentOrgId &&
                                                                <Imalla href="javascript:void(0);" permissionCode="pharmaceuticalCare:combination:portalCombination:update" className="gray-btn" text="修改" onClick={() => this.props.actions.showEditForm(true, record.id)}  />
                                                            }
                                                            {
                                                                record.orgId===record.currentOrgId &&
                                                                <Imalla href="javascript:void(0);" permissionCode="pharmaceuticalCare:combination:portalCombination:delete" className="gray-btn" text="删除" onClick={() => this.props.actions.showDelConfirm(true, record.id)}  />
                                                            }
                                                        </div>
                                                    }
                                                </td>
