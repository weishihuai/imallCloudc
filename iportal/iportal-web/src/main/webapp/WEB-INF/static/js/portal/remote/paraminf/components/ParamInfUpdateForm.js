...
import {portalParamInfUpdateModal} from '../actions';
import {validate} from '../../../../common/common-validate';

export const fields = ['id', 'paramGroupTypeCode', 'paramTypeCode', 'innerCode' ,'paramNm','paramDescr','paramValue']

class ParamInfUpdateForm extends Component {
    render() {
        const { portalParamInfUpdateModal,fields: {id, paramGroupTypeCode, paramTypeCode, innerCode ,paramNm,paramDescr,paramValue}, resetForm, handleSubmit, submitting } = this.props
        return (
            <form className="form-horizontal" onSubmit={handleSubmit}>
                ...
                <div className="modal-footer" style={{"background":"none"}}>
                    ...
                    <button className="btn btn-default ngdialog-custom-close" type="button" disabled={submitting} onClick={portalParamInfUpdateModal}>
                        关闭
                    </button>
                </div>
            </form>
...
ParamInfUpdateForm = reduxForm({
    form: 'synchronousValidation',
    fields,
    validate
})(ParamInfUpdateForm);

ParamInfUpdateForm = connect(
    mapStateToProps,
    mapDispatchToProps
)(ParamInfUpdateForm);

export default ParamInfUpdateForm