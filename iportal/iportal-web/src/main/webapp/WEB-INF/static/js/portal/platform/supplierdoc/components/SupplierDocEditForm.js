    ...
    return (<div className="item w860">
        <p>{required && <i>*</i>}{label}</p>
        {
            allItems.map((allItem, index) => {
                if (selectedItems.indexOf(allItem.dictItemCode) == -1) {
...
class SupplierDocEditForm extends React.Component {
    ...
    componentDidMount() {
        ...
        //预处理
        for (var i = 0; i < supplierDocCertificatesFileList.length; i++) {
            switch (supplierDocCertificatesFileList[i].certificatesType) {
                case "BUSINESS_LICENSE":
                    $('input[name="BUSINESS_LICENSE"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="BUSINESS_LICENSETIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    change("BUSINESS_LICENSE", supplierDocCertificatesFileList[i].certificatesNum);
                    change("BUSINESS_LICENSETIME", supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                case "ORGANIZATION_CERTIFICATE":
                    $('input[name="ORGANIZATION_CERTIFICATE"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="ORGANIZATION_CERTIFICATETIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                case "GSP_CERTIFICATE":
                    $('input[name="GSP_CERTIFICATE"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="GSP_CERTIFICATETIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                case "COMMODITY_LICENSE":
                    $('input[name="COMMODITY_LICENSE"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="COMMODITY_LICENSETIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                case "GSP_CERTIFICATE":
                    $('input[name="GSP_CERTIFICATE"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="GSP_CERTIFICATETIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                ...
                case "QUALITY_AGREEMENT":
                    $('input[name="QUALITY_AGREEMENT"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="QUALITY_AGREEMENTTIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                case "FOOD_CIRCULATION_LICENSE":
                    $('input[name="FOOD_CIRCULATION_LICENSE"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="FOOD_CIRCULATION_LICENSETIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                case "FOOD_HYGIENE_LICENSE":
                    $('input[name="FOOD_HYGIENE_LICENSE"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="FOOD_HYGIENE_LICENSETIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                case "HEALTH_PRODUCT_HYGIENE_LICENSE":
                    $('input[name="HEALTH_PRODUCT_HYGIENE_LICENSE"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="HEALTH_PRODUCT_HYGIENE_LICENSETIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                case "MEDIC_DEVICE_MANUFACTURE_PERMISS":
                    $('input[name="MEDIC_DEVICE_MANUFACTURE_PERMISS"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="MEDIC_DEVICE_MANUFACTURE_PERMISSTIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                case "COSMETICS_BUSINESS_LICENSE":
                    $('input[name="COSMETICS_BUSINESS_LICENSE"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="COSMETICS_BUSINESS_LICENSETIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                case "COSMETICS_HYGIENIC_LICENSE":
                    $('input[name="COSMETICS_HYGIENIC_LICENSE"]').val(supplierDocCertificatesFileList[i].certificatesNum);
                    $('input[name="COSMETICS_HYGIENIC_LICENSETIME"]').val(supplierDocCertificatesFileList[i].certificatesValidityString);
                    break;
                default :
            }
        }
    ...
    businessCategoryChangeEven(e) {
        ...
        var categoryItemSelects = form.supplierDocEditForm.values.businessCategory.split(',');
    ...
    businessRangeChangeEven(e) {
        ...
        var RangeItemSelects = form.supplierDocEditForm.values.businessRange.split(',');
    ...
    render() {
        ...
        const showUpdate = props.actions.showUpdate;
                ...
                <div className="layer" >
                    <div className="layer-box layer-info layer-order layer-stores layer-stores-modify">
                        <div className="layer-header">
                            <span>供应商信息</span>
                            <a href="javascript:void(0);" className="close" onClick={() => { showUpdate(false) }}></a>
                        </div>
...
SupplierDocEditForm.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
    submitting: PropTypes.bool.isRequired
};
SupplierDocEditForm.contextTypes = {
...
SupplierDocEditForm = reduxForm({
    form: "supplierDocEditForm",
    asyncBlurFields: ['supplierNm'],
    asyncValidate: asyncValidateForSaveOrUpdate
})(SupplierDocEditForm);

SupplierDocEditForm = connect(
    mapStateToProps,
    mapDispatchToProps
)(SupplierDocEditForm);

export default SupplierDocEditForm