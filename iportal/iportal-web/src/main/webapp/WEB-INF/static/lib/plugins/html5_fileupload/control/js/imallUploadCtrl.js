	...
	$.fn.zyUpload = function(options,param){
		...
		return this.each(function(){
			...
			this.createHtml = function(){
	            ...
	            $(self).append(html).css({"width":para.width,"height":para.height,"overflow":"hidden","margin":" 5px"});
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				// 处理不同类型文件代表的图标
				var fileImgSrc = "static/lib/plugins/html5_fileupload/control/images/fileType/";
