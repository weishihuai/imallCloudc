        ...
        <form id="loginForm" action="" method="post" onsubmit="return validation()">
            <div class="cont">
                <div class="item">
                    ...
                    <input type="text" class="form-control" id="username" name="username" placeholder="用户名" value="<shiro:principal/>" />
                </div>
                <div class="item">
                ...
                <div class="item">
                    ...
                    <input id="validateCode" name="validateCode" maxlength="4" type="text" class="input_bg" style="width:155px;" tabindex="4"  placeholder="验证码"/>
